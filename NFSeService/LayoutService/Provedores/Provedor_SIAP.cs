...
{
    public class Provedor_SIAP : AbstractProvedor, IProvedor
    {
        public Provedor_SIAP()
        {
            this.Nome = EnumProvedor.SIAP;
        }
        ...
        public override XmlDocument GeraXmlNota(FrgNFSe nota)
        {
            ...
            var nodeEnviarLoteRpsEnvio = CriaHeaderXml("san", "EnviarLoteRpsEnvio", ref doc);
            ...
            var nodeInfDeclaracaoPrestacaoServicoAttribute = doc.CreateAttribute("Id");
            nodeInfDeclaracaoPrestacaoServicoAttribute.Value = "rps" + nota.Documento.TDFe.Tide.FIdentificacaoRps.FNumero;
            nodeInfDeclaracaoPrestacaoServico.Attributes.Append(nodeInfDeclaracaoPrestacaoServicoAttribute);

            Extensions.CriarNoNotNull(doc, nodeInfDeclaracaoPrestacaoServico, "Id", nota.Documento.TDFe.Tide.FIdentificacaoRps.FNumero);
            ...
            Extensions.CriarNoNotNull(doc, nodeServicoValores, "ValTotTributos",
                                Generico.FormataValor(
                                    nota.Documento.TDFe.TServico.FValores.FValorIss
                                ...
                                #region "EnumRespostaRPS"    
                                {
                                    switch (x.Name.ToString().ToLower())
                                    {
                                        case "cancelarnfseresposta": //CancelarRPS
                                            _EnumRespostaRPS = EnumRespostaRPS.CancelarNfseResposta; break;
                                        ...
                                        case "enviarloterpsresposta":
                                            _EnumRespostaRPS = EnumRespostaRPS.EnviarLoteRpsResposta; break;
                                    }
                                    break;
